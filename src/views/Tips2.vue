       ...
       <div class="whole">
         ...
         <div class="top" v-for="(item,index) in data.health" :key='index'>
             ...
             <div class="right_box">
                ...
                <div class="learn_more" v-if="en" @click="listClick(item.id)">For more healthy eating tips, please click ...<span class="iconfont icon-youjiantou_huaban" style="padding-left:25px;font-weight:bold;"></span></div>
                 <div class="learn_more" v-else @click="listClick(item.id)">更多健康饮食小贴士请点击 ...<span class="iconfont icon-youjiantou_huaban" style="padding-left:25px;font-weight:bold;"></span></div>
            </div>
            </div>
